...
const noSpendingDiv = document.getElementById('no-spending');
const spendingListEl = document.getElementById('spending-list');
const noReceivingDiv = document.getElementById('no-receiving');
const receivingListEl = document.getElementById('receiving-list');
